...
function App() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <CssBaseline />
      <AppBar onCountrySelect={handleCountrySelect} />
      <main>
        <HeroUnit onSearch={handleSearch} weaponNames={weaponNames} weaponCategory={weaponCategory} onCategorySelect={handleCategorySelect} weaponManufacturer={weaponManufacturer} onManufacturerSelect={handleManufacturerSelect}/>
        <CardGrid selectedCountry={selectedCountry} searchValue={searchValue} selectedCategory={selectedCategory} selectedManufacturer={selectedManufacturer}  />
      </main>
      <Footer />
    </ThemeProvider>
  );
